...
export const installation = Object.freeze({
  githubOwner: 'nainbread',
  scoutRepository: 'scout',
  factoryRepository: 'project-factory',
  firebaseProject: 'elena-68e00',
  hostingSite: 'elena-68e00',
  publicUrl: 'https://elena-68e00.web.app',
  rootApp: 'cell',
  ...
  mediaBaseUrl: 'https://nainbread.github.io/HQ_videos',
  previewUrl: 'https://elena-68e00.web.app/editor-preview',
  iosBundleId: 'com.example.factory',
  iosAppName: 'factory',
  iosDevelopmentTeam: '', // Your Apple team ID, or blank to choose in Xcode.
});
